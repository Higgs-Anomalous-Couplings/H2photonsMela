...
// Fri Nov  5 17:35:42 2021 by ROOT version 6.14/09
// from TTree vbf_125_13TeV_GeneralDipho/vbf_125_13TeV_GeneralDipho
// found on file: /eos/cms/store/group/phys_higgs/emanuele/vbfhgg_ac/VBFHiggs_UL2017_24September2021/output_VBFHiggs0L1f05ph0ToGG_M125_TuneCP5_13TeV-JHUGenV7011-pythia8.root
//////////////////////////////////////////////////////////

#ifndef FggTreeBase_h
#define FggTreeBase_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         has3Jet;
   Float_t         dijet_mva;
   Float_t         dijet_mva_prob_VBF;
   Float_t         dijet_mva_prob_ggH;
   Float_t         dijet_mva_prob_bkg;
   ...
   Float_t         gghMVA_leadPhi;
   Float_t         gghMVA_subleadPhi;
   Float_t         gghMVA_subsubleadPhi;
   Float_t         gghMVA_leadJPt;
   Float_t         gghMVA_SubleadJPt;
   Float_t         gghMVA_SubsubleadJPt;
   Float_t         gghMVA_leadJEn;
   Float_t         gghMVA_SubleadJEn;
   Float_t         gghMVA_SubsubleadJEn;
   ...
   Float_t         vbfDnnResult_prob_bkg;
   Float_t         vbfDnnResult_prob_ggH;
   Float_t         vbfDnnResult_prob_VBF;
   ...
   TBranch        *b_has3Jet;   //!
   TBranch        *b_dijet_mva;   //!
   TBranch        *b_dijet_mva_prob_VBF;   //!
   TBranch        *b_dijet_mva_prob_ggH;   //!
   TBranch        *b_dijet_mva_prob_bkg;   //!
   ...
   TBranch        *b_gghMVA_leadPhi;   //!
   TBranch        *b_gghMVA_subleadPhi;   //!
   TBranch        *b_gghMVA_subsubleadPhi;   //!
   TBranch        *b_gghMVA_leadJPt;   //!
   TBranch        *b_gghMVA_SubleadJPt;   //!
   TBranch        *b_gghMVA_SubsubleadJPt;   //!
   TBranch        *b_gghMVA_leadJEn;   //!
   TBranch        *b_gghMVA_SubleadJEn;   //!
   TBranch        *b_gghMVA_SubsubleadJEn;   //!
   ...
   TBranch        *b_vbfDnnResult_prob_bkg;   //!
   TBranch        *b_vbfDnnResult_prob_ggH;   //!
   TBranch        *b_vbfDnnResult_prob_VBF;   //!
...
#ifdef FggTreeBase_cxx
FggTreeBase::FggTreeBase(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/cms/store/group/phys_higgs/emanuele/vbfhgg_ac/VBFHiggs_UL2017_24September2021/output_VBFHiggs0L1f05ph0ToGG_M125_TuneCP5_13TeV-JHUGenV7011-pythia8.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/cms/store/group/phys_higgs/emanuele/vbfhgg_ac/VBFHiggs_UL2017_24September2021/output_VBFHiggs0L1f05ph0ToGG_M125_TuneCP5_13TeV-JHUGenV7011-pythia8.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/eos/cms/store/group/phys_higgs/emanuele/vbfhgg_ac/VBFHiggs_UL2017_24September2021/output_VBFHiggs0L1f05ph0ToGG_M125_TuneCP5_13TeV-JHUGenV7011-pythia8.root:/vbfTagDumper/trees");
...
FggTreeBase::~FggTreeBase()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FggTreeBase::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FggTreeBase::LoadTree(Long64_t entry)
{
...
void FggTreeBase::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("dipho_PToM_vbfmva", &dipho_PToM_vbfmva, &b_dipho_PToM_vbfmva);
   ...
   fChain->SetBranchAddress("dijet_mva_prob_VBF", &dijet_mva_prob_VBF, &b_dijet_mva_prob_VBF);
   fChain->SetBranchAddress("dijet_mva_prob_ggH", &dijet_mva_prob_ggH, &b_dijet_mva_prob_ggH);
   fChain->SetBranchAddress("dijet_mva_prob_bkg", &dijet_mva_prob_bkg, &b_dijet_mva_prob_bkg);
   ...
   fChain->SetBranchAddress("gghMVA_leadPhi", &gghMVA_leadPhi, &b_gghMVA_leadPhi);
   fChain->SetBranchAddress("gghMVA_subleadPhi", &gghMVA_subleadPhi, &b_gghMVA_subleadPhi);
   fChain->SetBranchAddress("gghMVA_subsubleadPhi", &gghMVA_subsubleadPhi, &b_gghMVA_subsubleadPhi);
   ...
   fChain->SetBranchAddress("gghMVA_leadJEn", &gghMVA_leadJEn, &b_gghMVA_leadJEn);
   fChain->SetBranchAddress("gghMVA_SubleadJEn", &gghMVA_SubleadJEn, &b_gghMVA_SubleadJEn);
   fChain->SetBranchAddress("gghMVA_SubsubleadJEn", &gghMVA_SubsubleadJEn, &b_gghMVA_SubsubleadJEn);
   ...
   fChain->SetBranchAddress("vbfDnnResult_prob_bkg", &vbfDnnResult_prob_bkg, &b_vbfDnnResult_prob_bkg);
   fChain->SetBranchAddress("vbfDnnResult_prob_ggH", &vbfDnnResult_prob_ggH, &b_vbfDnnResult_prob_ggH);
   fChain->SetBranchAddress("vbfDnnResult_prob_VBF", &vbfDnnResult_prob_VBF, &b_vbfDnnResult_prob_VBF);
//    fChain->SetBranchAddress("dijet_minDRJetPho", &dijet_minDRJetPho, &b_dijet_minDRJetPho);
...
void FggTreeBase::Show(Long64_t entry)
{
...
Int_t FggTreeBase::Cut(Long64_t entry)
{
